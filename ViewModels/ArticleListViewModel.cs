namespace PawsPort.ViewModels
{
    public class ArticleListViewModel
    {
        ...
        public int PageSize { get; set; } = 10; //每頁顯示的資料數量，預設10筆
